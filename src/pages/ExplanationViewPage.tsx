...
function ExplanationViewPage() {
  ...
  if (!explanation) {
    return (
      <div className="flex flex-col min-h-screen bg-background">
        <AppHeader title="Explanation" onNewChat={handleNewChat} />
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center text-muted-foreground px-4">
            ...
            <Button variant="secondary" onClick={() => navigate('/explanations')}>
              Go to explanations
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <AppHeader title={title} onNewChat={handleNewChat} />
